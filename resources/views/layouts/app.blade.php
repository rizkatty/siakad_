...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/bg-login.png") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="#" style="color: white;">MTS GUNUNG GALESA PUTRI SUMBAWA</a>. </strong>
      </marquee>
    </footer>
  </div>
