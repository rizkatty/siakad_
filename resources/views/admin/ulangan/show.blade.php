                            ...
                            @foreach ($mapel as $val => $data)
                                ...
                                <tr>
                                   @if($data->mapel->nama_mapel != "Nilai Sikap")
                                        ...
                                        @endphp
                                        <td class="ctr">{{ optional($data->cekUlangan($jsonData))['ulha_1'] ?? '-' }}</td>
                                        <td class="ctr">{{ optional($data->cekUlangan($jsonData))['ulha_2'] ?? '-' }}</td>
                                        <td class="ctr">{{ optional($data->cekUlangan($jsonData))['uts'] ?? '-' }}</td>
                                        <td class="ctr">{{ optional($data->cekUlangan($jsonData))['ulha_3'] ?? '-' }}</td>
                                        <td class="ctr">{{ optional($data->cekUlangan($jsonData))['uas'] ?? '-' }}</td>
                                   @endif
                                </tr>
                            @endforeach
                    </tbody>
