                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td class="ctr">{{ $data->cekSikap($jsonData)['sikap_1'] ?? 'Belum disi' }}</td>
                                <td class="ctr">{{ $data->cekSikap($jsonData)['sikap_2'] ?? 'Belum disi' }}</td>
                                <td class="ctr">{{ $data->cekSikap($jsonData)['sikap_3'] ?? 'Belum disi' }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
