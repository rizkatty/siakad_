                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            ...
                            <tr>
                                <th class="ctr">Spiritual</th>
                                <th class="ctr">Sosial</th>
                                <th class="ctr">Ahlak</th>
                            </tr>
                        </thead>
                        <tbody>
                            <form action="" method="post">
                                ...
                                <tr>
                                    ...
                                    @else
                                    <td class="ctr">
                                        <input type="text" name="sikap_1" maxlength="1" style="margin: auto;" class="form-control text-center sikap_1_{{$data->id}}" autocomplete="off" autofocus>
                                    </td>
                                    @endif
                                    ...
                                    @else
                                    <td class="ctr"><input type="text" name="sikap_2" maxlength="1" style="margin: auto;" class="form-control text-center sikap_2_{{$data->id}}" autocomplete="off" autofocus></td>
                                    @endif
                                    ...
                                    @else
                                    <td class="ctr"><input type="text" name="sikap_3" maxlength="1" style="margin: auto;" class="form-control text-center sikap_3_{{$data->id}}" autocomplete="off" autofocus></td>
                                    @endif
