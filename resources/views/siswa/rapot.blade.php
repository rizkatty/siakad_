            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        @if ($nilaisikap)
                            @php
                                $sikap = (($nilaisikap->sikap_1 + $nilaisikap->sikap_2 + $nilaisikap->sikap_3) / 2);
                                $sikap = (int) $sikap;
                            @endphp
                            @if ($sikap == 4)
                                <div class="alert alert-success alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h5><i class="icon fas fa-check"></i> Sangat Baik! (Nilai: {{ $sikap }}) </h5>
                                    Siswa Memiliki Nilai Sikap Yang Sangat Bagus
                                </div>
                            @elseif ($sikap == 3)
                                <div class="alert alert-success alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h5><i class="icon fas fa-check"></i> Baik! (Nilai: {{ $sikap }})</h5>
                                    Students show good manners.
                                </div>
                            @elseif ($sikap == 2)
                                <div class="alert alert-success alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h5><i class="icon fas fa-check"></i> Cukup! (Nilai: {{ $sikap }})</h5>
                                    Students show sufficient attitude.
                                </div>
                            @else
                                <div class="alert alert-success alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h5><i class="icon fas fa-check"></i> Kurang! (Nilai: {{ $sikap }})</h5>
                        ...
                        @else
                            <div class="alert alert-warning alert-dismissible">
                                ...
                                Warning. Nilai sikap belum dimasukan
                            </div>
                        @endif
                    </div>
                    <div class="col-12 mb-3">
