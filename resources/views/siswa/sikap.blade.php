                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="ctr">{{ $data->sikap($data->id)['sikap_1'] ?? 'Belum disi' }}</td>
                                <td class="ctr">{{ $data->sikap($data->id)['sikap_2'] ?? 'Belum disi' }}</td>
                                <td class="ctr">{{ $data->sikap($data->id)['sikap_3'] ?? 'Belum disi' }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
