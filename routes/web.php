...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['siswa'])->group(function () {
    ...
    Route::get('/tugas/siswa', 'SiswaController@tugas')->name('tugas.siswa');
    Route::get('/materipelajaran/siswa', 'SiswaController@materipelajaran')->name('materipelajaran.siswa');
  });

  Route::middleware(['guru'])->group(function () {
    Route::get('/absen/harian', 'GuruController@absen')->name('absen.harian');
    Route::get('/absensi/kelas', 'GuruController@absensi_kelas')->name('absensi.kelas');
    Route::get('/absensi/mapel/{kelas_id}', 'GuruController@absensi_mapel')->name('absensi.mapel');
    Route::get('/absensi/siswa/{kelas_id}/{mapel_id}', 'GuruController@daftar_absensi')->name('daftar.absensi');
    Route::post('/absensi/store/{mapel_id}', 'GuruController@store_absensi')->name('store.absensi');

    Route::get('/absensi/rekap_absensi', 'GuruController@rekap_absensi')->name('rekap.absensi');
    Route::get('/absensi/rekap_absensi_mapel/{kelas_id}', 'GuruController@rekap_absensi_mapel')->name('rekap.absensi.mapel');
    Route::get('/absensi/rekap_absensi_siswa/{kelas_id}', 'GuruController@rekap_absensi_siswa')->name('rekap_absensi_siswa');
    ...
    Route::get('/kelas', 'KelasController@index')->name('kelas.guru');
    ...
    Route::get('/tugas-kelas', [TugasKelasController::class, 'index'])->name('tugas.kelas');
    Route::resource('/tugas_kelas', 'TugasKelasController');
    Route::resource('materi_pelajaran', 'MateriPelajaranController');
    Route::get('/materi-pelajaran', [MateriPelajaranController::class, 'index'])->name('materi.pelajaran');
  ...
  Route::middleware(['admin'])->group(function () {
    Route::middleware(['trash'])->group(function () {
      ...
      //routes for walikelas
        Route::get('/walikelas/list', 'WaliKelasController@index')->name('walikelas.list');
        Route::post('/walikelas/store',  'WaliKelasController@store')->name('walikelas.store');
        Route::put('/walikelas/{id}', 'WaliKelasController@update')->name('walikelas.update');
        Route::delete('/walikelas/{id}', 'WaliKelasController@destroy')->name('walikelas.destroy');
        //
    ...
    Route::resource('/tahun_pelajaran', 'TahunPelajaranController');

    //routes untuk profile sekolah
